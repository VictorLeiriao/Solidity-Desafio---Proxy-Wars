...
export type { BankV1 } from "./contracts/BankV1";
export { BankV1__factory } from "./factories/contracts/BankV1__factory";
export type { BankV2 } from "./contracts/BankV2";
export { BankV2__factory } from "./factories/contracts/BankV2__factory";
export type { BankV3 } from "./contracts/BankV3";
...
export type { BankV5BETA } from "./contracts/BankV5BETA";
export { BankV5BETA__factory } from "./factories/contracts/BankV5BETA__factory";
export type { BankV6 } from "./contracts/BankV6";
export { BankV6__factory } from "./factories/contracts/BankV6__factory";
export type { BankV7 } from "./contracts/BankV7";
export { BankV7__factory } from "./factories/contracts/BankV7__factory";
export type { BankV8 } from "./contracts/BankV8";
export { BankV8__factory } from "./factories/contracts/BankV8__factory";
export type { BankV9 } from "./contracts/BankV9";
export { BankV9__factory } from "./factories/contracts/BankV9__factory";
