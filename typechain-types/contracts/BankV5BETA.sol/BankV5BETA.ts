...
export interface BankV5BETAInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface BankV5BETA extends BaseContract {
  connect(runner?: ContractRunner | null): BankV5BETA;
  waitForDeployment(): Promise<this>;

  interface: BankV5BETAInterface;
