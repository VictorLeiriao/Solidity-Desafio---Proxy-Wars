...
export interface BankV4Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface BankV4 extends BaseContract {
  connect(runner?: ContractRunner | null): BankV4;
  waitForDeployment(): Promise<this>;

  interface: BankV4Interface;
