...
export interface BankV3Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface BankV3 extends BaseContract {
  connect(runner?: ContractRunner | null): BankV3;
  waitForDeployment(): Promise<this>;

  interface: BankV3Interface;
